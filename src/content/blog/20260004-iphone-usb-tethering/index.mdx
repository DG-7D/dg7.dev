...
- 「[Appleデバイス](https://apps.microsoft.com/detail/9np83lwlpz9k)」アプリをインストール
- 再起動または「Appleデバイス」起動後、インターネット共有が有効な状態で再度Windows Update
...
なお、このドライバは通常版iTunesに同じバージョンのものが<del>同梱されている。7-zip等で`iTunes64Setup.exe/AppleMobileDeviceSupport64.msi/`を覗けば転がっている。ストア版は知らん。</del>かつては同梱されていたが、現行バージョンでは消滅していた。
